...
## Summary
- Submissions of types *Falsification* and *Unsupported Claim* will be accepted starting July 16 2021 at 11pm UTC and ending July 23, 2021 at 11pm UTC or when the $10,000 total has been reached, whichever happens first.
...
- This is a two phase process: Stage 1 is about submitting Falsification candidates and Unsupported Claim candidates, while Stage 2 is about refutations of the Falsification candidates that have been validated, as well as providing effective citations for the validated Unsupported Claim candidates.
...
### 3. Responses
Each entry will be filtered by volunteers to make sure they pass our criteria. The ones that do will be reviewed and rated by the referees (more details on that further down).
Once a submission is rated as validated by the referees, the @BetterSkeptics account will automatically issue a tweet with the hashtag #gtcvalid informing the submitter of the decision.
Anyone will then have 48 hours to contest the referees' decision.
...
Each submission MUST contain all the necessary material to document your claim or contest. Referrees are not obliged to do their own research to document a claim, it must be the claim or contest itself that explains its case clearly and concisely. If a claim requires more than 10 minutes from the referree, it may be rejected even if the necessary material may be, in principle, found.
...
If several challenges are validated against the same claim and succeed past the refutation stage, only the first one, by time of initial submission, will be rewarded. 
...
## Responses
Each referee-validated submission will be broadcast via the @BetterSkeptics Twitter account, giving 48 hours for citations in support for "Unsupported claim" submissions, and reasons for reversal for every "Falsification" submission. Referees will review both the submission tweet that was made on the @BetterSkeptics account and the original submission tweet's replies for refutation of the falsification attempt.

## Response sanity checking & referee review
After the 48 hours have passed, the replies to the original submissions will be similarly sanity-checked and reviewed by the referees. If their view of the original submission is altered by the new evidence, each referree will indicate the reply/replies that helped change their minds. Each referee controls 1/3 of the total $100 award for each reversal, so if all 3 referees point to the same reply, it will receive the equivalent of $100. If they are split, or if a referee indicates multiple responses as helping change their mind, the award will be split accordingly.
